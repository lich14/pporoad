...
class PPOnet(nn.Module):
    ...
    def __init__(self):
        ...
        self.cnn_base = nn.Sequential(  # input shape (1, 28, 28)
            ...
            nn.ReLU(),  # activation
            nn.MaxPool2d(2))
        self.v = nn.Sequential(nn.Linear(576, 10000), nn.ReLU(), nn.Linear(10000, 1))
        self.fc = nn.Sequential(nn.Linear(576, 10000), nn.ReLU())
        self.alpha_head = nn.Sequential(nn.Linear(10000, 4), nn.Softplus())
        self.beta_head = nn.Sequential(nn.Linear(10000, 4), nn.Softplus())
...
class sumomodel():
    ...
    def __init__(self):
        ...
        self.memory = store()
        self.gamma = 0.95
        self.path_t7 = './checkpoint/p_sgd' + str(args.bound) + '.t7'
        self.path_wt = './csvfiles/averange_sgd' + str(args.bound) + '.csv'
        self.path_lsa = './csvfiles/loss_a_sgd' + str(args.bound) + '.csv'
        self.path_lsv = './csvfiles/loss_v_sgd' + str(args.bound) + '.csv'
        self.path_ac = './csvfiles/ac_sgd' + str(args.bound) + '.csv'
